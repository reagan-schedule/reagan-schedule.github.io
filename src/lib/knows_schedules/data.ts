 ...
 * Instructions
 * 
 * Copy everything starting at and excluding the opening bracket to the declaration of specialDates.
 * Paste it at the same position in this file.
...
export const strike = [
	...
	{ name: 'Period 4', id: 'p4', start: new Time(12, 15), end: new Time(13, 0) },
